...
public class Device {
	...
	public Device(int deviceId, int deviceType, String deviceIMEI, String deviceName, String deviceModel,
			float deviceVersion, String deviceMobile, int locationMode, int timeInterval, int alarmControl,
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + alarmControl;
	...
	public boolean equals(Object obj) {
		...
		if (alarmControl != other.alarmControl)
			return false;
	...
	public String toString() {
		return "Device [deviceId=" + deviceId + ", deviceType=" + deviceType + ", deviceIMEI=" + deviceIMEI
				...
				+ ", alarmControl=" + alarmControl + ", deviceStatus=" + deviceStatus + ", onlineTime=" + onlineTime
